...
public class NoteEntity implements Serializable {
    ...
    @Column(name = "font_size_mm")
    private Integer fontSizeMillimeters;
    ...
    public NoteEntity(UUID noteId, UUID updatedByUserId, OffsetDateTime dateModified, String message, Integer fontSizeMillimeters, String fontColor, String handwritingStyle) {
        this.noteId = noteId;
        this.updatedByUserId = updatedByUserId;
        this.dateModified = dateModified;
        this.message = message;
        this.fontSizeMillimeters = fontSizeMillimeters;
