...
import ai.salesfox.portal.rest.api.contact.interaction.ContactInteractionEndpointService;
...
public class ContactController {
    ...
    private final ContactInteractionEndpointService contactInteractionService;
    private final ContactBulkUploadService contactBulkUploadService;

    @Autowired
    public ContactController(ContactService contactService, ContactInteractionEndpointService contactInteractionService, ContactBulkUploadService contactBulkUploadService) {
    ...
    public MultiContactModel getContacts(
        ...
        return contactService.getContacts(active, query, offset, limit);
    }
