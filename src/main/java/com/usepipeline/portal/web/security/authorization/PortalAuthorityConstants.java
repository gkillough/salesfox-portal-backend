...
public final class PortalAuthorityConstants {
    ...
    public static final String PIPELINE_BASIC_USER_CHECK = "hasRole('PIPELINE_BASIC_USER')";

    public static final String PIPELINE_PREMIUM_USER = "PIPELINE_PREMIUM_USER";
    public static final String PIPELINE_PREMIUM_USER_CHECK = "hasRole('PIPELINE_PREMIUM_USER')";
