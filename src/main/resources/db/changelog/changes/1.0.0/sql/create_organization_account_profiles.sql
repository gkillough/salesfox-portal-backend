...
alter table portal.organization_account_profiles
    add CONSTRAINT profile_organization_account_id_fk FOREIGN KEY (organization_account_id) REFERENCES portal.organization_accounts(organization_account_id);

alter table portal.organization_account_profiles
    add CONSTRAINT profile_mailing_address_id_fk FOREIGN KEY (mailing_address_id) REFERENCES portal.organization_account_addresses(organization_account_address_id);